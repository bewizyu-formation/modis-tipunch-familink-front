...
export class CreateContactComponent implements OnInit {
  ...
  createContact(): void {
    ...
    if (this.email.valid &&  this.nom.valid && this.prenom.valid && this.numTel.valid) {
      this.authService.authenticateFormContact(this.email.value, this.nom.value, this.prenom.value, this.selectedValue,
        this.gravatar, this.adresse, this.codePostal,
